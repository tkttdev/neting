...
public class CharacterStoreController : SingletonBehaviour<CharacterStoreController> {
	...
	[SerializeField]
	private GameObject[] characterKey;

	[SerializeField]
	private GameObject statusPanel;
	[SerializeField]
	private Sprite[] characterStatus;
	[SerializeField]
	private Image showStatusImage;

	[SerializeField]
	private GameObject purchasePanel;
	[SerializeField]
	private Image showPurchaseStatusImage;
	[SerializeField]
	private Text purchaseMoneyText;
	[SerializeField]
	private Button purchaseButton;

	[SerializeField]
	private GameObject purchaseInfoPanel;
	[SerializeField]
	private Text purchaseInfoText;
	[SerializeField]
	private Image purchaseInfoCharacterImage;
	...
	private int tposx = 0;
	private int loop = 0;
	//dirFlagはTopCharacterLocation内でカメラが移している位置　false:左　true:右
	private bool dirFlag = true;
	//PurchaseButtonIdはキャラクターIDを格納
	private int PurchaseButtonId;
	//loopflagはTopCharacterLocation内でcharacterlocationの位置関係の情報　2 1 → true 1 2 →false
	private bool loopflag = true;
	[SerializeField]
	private GameObject TopCharacterLocation;
	[SerializeField]
	private GameObject CharacterLocation1;
	[SerializeField]
	private GameObject CharacterLocation2;
	[SerializeField]
	private Text purchaseButtonMoneyText;
	[SerializeField]
	private Button truePurchaseButton;
	[SerializeField]
	...
	private void MoveCharaLoc2(int _dir) {
		Vector3 pos = CharacterLocation2.transform.position;
		Vector3 pos2 = CharacterLocation1.transform.position;
		pos.x = pos2.x + 100f * _dir;
		CharacterLocation2.transform.position = pos;
	}

	private void MoveCharaLoc1(int _dir) {
		Vector3 pos = CharacterLocation1.transform.position;
		Vector3 pos2 = CharacterLocation2.transform.position;
		pos.x = pos2.x + 100f * _dir;
		CharacterLocation1.transform.position = pos;
