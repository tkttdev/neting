...
public static class CHARACTER_DEFINE {
	...
	public static readonly ReadOnlyCollection<int>    MONEYPATTERN        = Array.AsReadOnly(new int[]    {  0, 100, 100, 100, 150, 150, 150, 150, 150, 200, 200, 200, 200, 200, 250, 250, 250, 250, 250, 300});
	//public static readonly ReadOnlyCollection<int>    MONEYPATTERN2        = Array.AsReadOnly(new int[]    {  0, 150, 150, 150, 200, 200, 200, 200, 200, 250, 250, 250, 250, 250, 300, 300, 300, 300, 300, 350});
