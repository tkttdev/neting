...
public static class ENEMY_DEFINE {
    ...
    public static readonly ReadOnlyCollection<float> HP = Array.AsReadOnly(new float[] { 1, 1, 1, 1, 1, 1, 1, 2, 1, 3, 1, 9, 2, (float)1.5, 1 });
	...
	public static readonly ReadOnlyCollection<float> SPEED = Array.AsReadOnly(new float[]  { 2, 2, 2, 2, 2, 2, 5, 1, 3, 1, 2, 2, 2, 2, 2 });
